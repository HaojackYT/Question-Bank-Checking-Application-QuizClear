...
public class QuestionManagementController {
    ...
    private String loadQuestionBankData(Model model, String search, String subject, 
        ...
        try {
            ...
            System.out.println("Loaded " + questionDTOs.size() + " questions for Question Bank (page " + (page + 1) + "/" + questionPage.getTotalPages() + ")");
    ...
    private Page<Question> getFilteredQuestions(String search, String subject, String clo, String difficulty, Pageable pageable) {
