...
INSERT INTO users (full_name, email, password_hash, role, status, department, gender, date_of_birth, nation, phone_number, created_at, hometown, contact_address, work_place, qualification) VALUES
('Ash Abrahams', 'ash.abrahams@university.edu', 'hash_ab001', 'Lec', 'active', 'Computer Science', 'male', '1986-03-15', 'USA', '1234567101', '2025-01-01 09:00:00', 'Boston', '101 Elm St, Boston', 'University of Transport and Communications, Campus 3', 'MS in Information Technology - University of Transport and Communications, Vietnam - 2012'),
('Alexander Brooks', 'alex.brooks@university.edu', 'hash_ab002', 'HoD', 'active', 'Mathematics', 'male', '1975-09-20', 'UK', '1234567102', '2025-01-02 09:00:00', 'London', '22 Baker St, London', 'UTC - Faculty of Science, Campus 1', 'MSc in Computer Science - University of Transport and Communications - 2013'),
('Maria Gonzalez', 'maria.gonzalez@university.edu', 'hash_mg002', 'HoD', 'active', 'Mathematics', 'female', '1978-07-22', 'Spain', '1234567103', '2025-01-03 09:00:00', 'Madrid', '22 Gran Via, Madrid', 'University of Transport and Communications, Main Campus', 'Master of Information Technology - UTC - 2011'),
('Chen Wei', 'chen.wei@university.edu', 'hash_cw003', 'RD', 'inactive', 'Physics', 'male', '1990-05-10', 'China', '1234567104', '2025-01-04 09:00:00', 'Shanghai', '33 Nanjing Rd, Shanghai', 'UTC, Campus 2 - Transport University', 'MS in Software Engineering - University of Transport and Communications, Vietnam - 2014'),
('Aisha Khan', 'aisha.khan@university.edu', 'hash_ak004', 'SL', 'active', 'Chemistry', 'female', '1984-11-30', 'Pakistan', '1234567105', '2025-01-05 09:00:00', 'Karachi', '44 Clifton Rd, Karachi', 'Transport University - Faculty of Engineering, Campus 3', 'MSc in Information Systems - UTC - 2012'),
('Hiroshi Tanaka', 'hiroshi.tanaka@university.edu', 'hash_ht005', 'Lec', 'active', 'Biology', 'male', '1988-09-12', 'Japan', '1234567106', '2025-01-06 09:00:00', 'Osaka', '55 Umeda St, Osaka', 'University of Transport and Communications, Campus 1', 'Master of IT - University of Transport and Communications - 2015'),
('Elena Petrova', 'elena.petrova@university.edu', 'hash_ep006', 'HoED', 'active', 'Computer Science', 'female', '1982-04-25', 'Russia', '1234567107', '2025-01-07 09:00:00', 'Moscow', '66 Arbat St, Moscow', 'UTC - Campus 3, Faculty of Technology', 'MS in Computer Engineering - University of Transport and Communications, Vietnam - 2010'),
('Lucas Silva', 'lucas.silva@university.edu', 'hash_ls007', 'Lec', 'inactive', 'Mathematics', 'male', '1992-02-18', 'Brazil', '1234567108', '2025-01-08 09:00:00', 'Sao Paulo', '77 Paulista Ave, Sao Paulo', 'University of Transport and Communications, Campus 2', 'Master of Science in IT - UTC - 2013'),
('Fatima Ali', 'fatima.ali@university.edu', 'hash_fa008', 'RD', 'active', 'Physics', 'female', '1987-06-05', 'Egypt', '1234567109', '2025-01-09 09:00:00', 'Cairo', '88 Nile St, Cairo', 'Transport University, Campus 3', 'MSc in Information Technology - University of Transport and Communications - 2012'),
('James Park', 'james.park@university.edu', 'hash_jp009', 'SL', 'active', 'Chemistry', 'male', '1989-12-01', 'Korea', '1234567110', '2025-01-10 09:00:00', 'Seoul', '99 Gangnam Ave, Seoul', 'University of Transport and Communications, Faculty of IT, Campus 1', 'MS in Information Technology - UTC - Vietnam - 2011');
